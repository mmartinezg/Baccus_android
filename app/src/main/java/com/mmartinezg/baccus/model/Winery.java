...
public class Winery {
    ...
    private static Winery downloadingWines() throws IOException, JSONException {
        Winery winery = new Winery();
        winery.mWinesList = new LinkedList<>();
    ...
    public static boolean isInstaceAvailable(){
