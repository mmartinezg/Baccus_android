...
import com.mmartinezg.baccus.controller.activity.WebActivity;
import com.mmartinezg.baccus.model.Wine;

public class WineFragment extends Fragment{
    public static final String ARG_WINE = "ARG_WINE";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Accedemos a la vista desde el controlador
        ...
        mWineRatingBar.setRating(mWine.getRagin());
        mWineCompanyText.setText(mWine.getComanyName());
